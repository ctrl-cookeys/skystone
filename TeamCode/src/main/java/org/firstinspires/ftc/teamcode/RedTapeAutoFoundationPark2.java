...
public class RedTapeAutoFoundationPark2 extends LinearOpMode {
    ...
    private void moveFoundation() {
        ...
        drive.backward(18, DEFAULT_DRIVE_POWER, DEFAULT_DRIVE_TIMEOUT_SECS);
        sleep(500);
        drive.backward(10, 0.2, DEFAULT_DRIVE_TIMEOUT_SECS);
        sleep(500);
        grabber.engage();
        sleep(1000);
        drive.forward(30, 0.2, DEFAULT_DRIVE_TIMEOUT_SECS); //org 25
        sleep(500);
       // curveDrive(1, 0, 1000);
        /*grabber.release();
        sleep(1000);
        ...
        drive.rotateLeft(69 , DEFAULT_ROTATE_POWER);
        drive.forward(25, DEFAULT_DRIVE_POWER, DEFAULT_DRIVE_TIMEOUT_SECS);
