...
@Autonomous(name = "RedTapeAutoFoundationParkNew", group = "LQ")
@Disabled
@Deprecated

public class RedTapeAutoFoundationParkNew extends LinearOpMode {
    ...
    private void moveFoundation() {
        ...
        drive.backward(12, 0.7, DEFAULT_DRIVE_TIMEOUT_SECS);
