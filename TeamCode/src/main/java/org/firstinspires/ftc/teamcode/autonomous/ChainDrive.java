...
/*
    After the 14th League, we should have only 1 base class and have chain drive and direct drive as sub-class.
...
public class ChainDrive {
     ...
     * Constructor
     */
    public ChainDrive(Robot cBot, Telemetry telemetry, LinearOpMode linearOpMode) {
    ...
    private void driveByEncoder(double power,
        ...
        if (linearOpMode.opModeIsActive()) {
            ...
            newLeftTarget = cBot.leftDrive.getCurrentPosition() + (int) (leftInches * Constants.ChainDrive.COUNTS_PER_INCH);
            newRightTarget = cBot.rightDrive.getCurrentPosition() + (int) (rightInches * Constants.ChainDrive.COUNTS_PER_INCH);
